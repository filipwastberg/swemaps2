...
The `swemaps` package provide map objects to easily make beautiful maps of Sweden in R. 
...
`swemaps` contain simple features (sf) objects that make it easy to create maps over Sweden.
