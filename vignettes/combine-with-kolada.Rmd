---
title: "combine-with-kolada"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{combine-with-kolada}
...
[Kolada](https://www.kolada.se/) is a data cooperation between Swedish municipalities and regions. Through their website you can find a rich variety of different statistics. Many of these come from Statistics Sweden (SCB) and some come from the regions themselves. 
...
We can use the [rKolada](https://lchansson.github.io/rKolada/) package to query data from Kolada.

This is a great package that is easy to use. Below we pull data from Kolada on how many housing projects that have been granted building approval.
